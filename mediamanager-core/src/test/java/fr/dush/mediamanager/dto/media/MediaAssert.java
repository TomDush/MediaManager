...
public class MediaAssert extends AbstractAssert<MediaAssert, Media> {
  ...
  /**
   * An entry point for MediaAssert to follow Fest standard <code>assertThat()</code> statements.<br>
   * With a static import, one's can write directly : <code>assertThat(myMedia)</code> and get specific assertion with code completion.
   * @param actual the Media we want to make assertions on.
  ...
  public MediaAssert hasCreation(Date creation) {
    ...
    // check
    if (!actual.getCreation().equals(creation)) { throw new AssertionError(errorMessage); }
  ...
  public MediaAssert hasOtherMetaData(String otherMetaData) {
    ...
    // check
    if (!actual.getOtherMetaData().equals(otherMetaData)) { throw new AssertionError(errorMessage); }
  ...
  public MediaAssert hasPoster(String poster) {
    ...
    // check
    if (!actual.getPoster().equals(poster)) { throw new AssertionError(errorMessage); }
  ...
  public MediaAssert hasSeen(int seen) {
    ...
    // check
    if (actual.getSeen() != seen) { throw new AssertionError(errorMessage); }
