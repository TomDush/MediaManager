...
public class RootDirectoryManagerImplTest extends SimpleJunitTest {
    ...
    public void testSave_KO() throws Exception {
        when(rootDirectoryDAO.findUsingPath(anyCollectionOf(String.class))).thenReturn(Lists.newArrayList(new RootDirectory(),
                                                                                                          new RootDirectory()));
    ...
    public void testNonUpdatable() throws Exception {
        ...
        final RootDirectory existing = new RootDirectory("Existing Directory",
                                                         MediaType.MOVIE,
                                                         "/home/medias/movies/vf",
        ...
        try {
            rootDirectoryManager.createOrUpdateRootDirectory(new RootDirectory("My Directory",
                                                                               MediaType.MOVIE,
                                                                               "/home/medias/movies",
                                                                               "/home/media/collections/Marvels",
                                                                               "/mnt/remote/movies"));
            failBecauseExceptionWasNotThrown(RootDirectoryAlreadyExistsException.class);
    ...
    public void testNewRootDirectory() throws Exception {
        final RootDirectory root =
                new RootDirectory("My Directory", MediaType.MOVIE, "/home/medias/movies", "../collections");
        ...
        verify(rootDirectoryDAO).findUsingPath(newHashSet(PathsUtils.toAbsolute("/home/medias/movies"),
                                                          PathsUtils.toAbsolute("../collections")));
        verify(rootDirectoryDAO).saveOrUpdate(root);
    }

    @Test
    public void testUpdateWithSameId() throws Exception {
        final RootDirectory existing =
                new RootDirectory("My Directory", MediaType.MOVIE, "/home/medias/movies", "/home/medias/collections");
        when(rootDirectoryDAO.findUsingPath(anyCollectionOf(String.class))).thenReturn(Lists.newArrayList(existing));
        when(rootDirectoryDAO.findById(anyString())).thenReturn(existing);

        final RootDirectory returned =
                rootDirectoryManager.createOrUpdateRootDirectory(new RootDirectory("My Directory",
                                                                                   MediaType.MOVIE,
                                                                                   "/home/medias"));
    ...
    public void testMergeWIthoutChangeId() throws Exception {
        final RootDirectory existing = new RootDirectory("Existing Directory",
                                                         MediaType.MOVIE,
                                                         "/home/medias/movies/vf",
                                                         "/home/medias/movies/collections",
                                                         "/home/medias/shows");
        existing.setEnricher("oldEnricher");

        when(rootDirectoryDAO.findUsingPath(anyCollectionOf(String.class))).thenReturn(Lists.newArrayList(existing));

        final RootDirectory update = new RootDirectory("My Directory",
                                                       MediaType.MOVIE,
                                                       "/home/medias/movies",
                                                       "/home/media",
                                                       "/home/medias/shows/pilots",
                                                       "/mnt/remote/movies");
        update.setEnricher("newEnricher");
        final RootDirectory returned = rootDirectoryManager.createOrUpdateRootDirectory(update);

        assertThat(returned).isEqualTo(existing);
        assertThat(returned.getPaths()).containsOnly(PathsUtils.toAbsolute("/home/medias/movies"),
                                                     PathsUtils.toAbsolute("/home/media"),
                                                     "/home/medias/shows",
                                                     PathsUtils.toAbsolute("/mnt/remote/movies"));
