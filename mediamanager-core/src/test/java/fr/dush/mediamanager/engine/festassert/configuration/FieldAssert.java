...
public class FieldAssert extends AbstractAssert<FieldAssert, Field> {
    ...
    /**
     * An entry point for FieldAssert to follow Fest standard <code>assertThat()</code> statements.<br> With a static
     * import, one's can write directly : <code>assertThat(myField)</code> and get specific assertion with code
     * completion.
     *
     * @param actual the Field we want to make assertions on.
    ...
    public FieldAssert hasDescription(String description) {
        ...
        // we overrides the default error message with a more explicit one
        String errorMessage =
                format("Expected Field's description to be <%s> but was <%s>", description, actual.getDescription());
