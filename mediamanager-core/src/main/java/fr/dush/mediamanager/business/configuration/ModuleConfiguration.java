...
/**
 * An <code>ModuleConfiguration</code> instance is created for each module. It initialized by properties file with default values, and it saved into
 * database or properties file to persist changes.
 *
...
public class ModuleConfiguration {
	...
	/**
	 * Read property is this order :
	 * <ul>
	 * <li>Module specific value (value set in database, or property file)</li>
	 * <li>Global generic value : defined for all application</li>
	 * <li>System properties</li>
	 * <li>Given default properties</li>
	 * <li>Default module specific value</li>
	 * <li>Default generic value</li>
	 * </ul>
	 *
	 * @param key
