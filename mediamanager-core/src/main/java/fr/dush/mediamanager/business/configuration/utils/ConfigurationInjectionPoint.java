...
public class ConfigurationInjectionPoint implements IConfigurationArguments {
    ...
    // TODO Implement ConfigurationInjectionPoint with BeanPostProcessor concept
    ...
    //			if (module == null) {
    //				throw new ConfigurationException(generateErrorString(point, "Class %s must be Module to be used as
    // entryPoint.",
