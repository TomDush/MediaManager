...
public class ConfigurationFieldAssert extends AbstractAssert<ConfigurationFieldAssert, ConfigurationField> {
   ...
   * With a static import, one's can write directly : <code>assertThat(myConfigurationField)</code> and get specific assertion with code completion.
   * @param actual the ConfigurationField we want to make assertions on.
  ...
  public ConfigurationFieldAssert hasDescription(String description) {
    ...
    // we overrides the default error message with a more explicit one
    String errorMessage = format("Expected ConfigurationField's description to be <%s> but was <%s>", description, actual.getDescription());
  ...
  /**
   * Verifies that the actual ConfigurationField's fullname is equal to the given one.
   * @param fullname the given fullname to compare the actual ConfigurationField's fullname to.
   * @return this assertion object.
   * @throws AssertionError - if the actual ConfigurationField's fullname is not equal to the given one.
   */
  public ConfigurationFieldAssert hasFullname(String fullname) {
    ...
    // we overrides the default error message with a more explicit one
    String errorMessage = format("Expected ConfigurationField's fullname to be <%s> but was <%s>", fullname, actual.getFullname());
    
    // check
    if (!actual.getFullname().equals(fullname)) { throw new AssertionError(errorMessage); }
  ...
  public ConfigurationFieldAssert hasValue(String value) {
    ...
    // we overrides the default error message with a more explicit one
    String errorMessage = format("Expected ConfigurationField's value to be <%s> but was <%s>", value, actual.getValue());
